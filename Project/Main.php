...
<div id="subsidebar2">
  <dl class="dropdown">
    ...
    <dd id="<?php echo $i;?>-ddcontent" onmouseover="cancelHide('<?php echo $i;?>')" onmouseout="ddMenu('<?php echo $i;?>',-1)">
        ...
        <li><a href="mainproduct.php?cat=<?php echo $category;?>&un=<?php echo base64_encode($username);?>" class="underline"><?php echo $sub_category;?></a></li>
 <?php
              }
 ?>
      </ul>
...
<?php
 ...
 <tr>
   <td align="center" width="40"><input type="checkbox" name="chk<?php echo $i; ?>" id="chk<?php echo $i; ?>" value="<?php echo $prid; ?>"></td>
    ...
    <td width="250"><p align="center">Discription : <br/> <br/>
                     <br/>
...
<?php  echo $pagination;  ?> 
  ...
  <div id="footer">
    (C) Copyright Srijan Vasu Vipul . Limited
    <!-- end #footer -->
  </div>
  <!-- end #container -->
</div>
